...
alias ls="ls --color --group-directories-first \
          --quoting-style=literal -pq --show-control-chars"
...
alias py="python3"
alias nf="neofetch"
alias storage="df -h -x tmpfs --total"
...
# Fzf
alias pac-install="pacman -Slq | fzf --multi --preview 'pacman -Si {1}' | \
                   xargs -ro doas pacman -S"
alias pac-uninstall="pacman -Qq | fzf --multi --preview 'pacman -Qi {1}' | \
